...
<body class="bg-light p-3 p-md-5">
    ...
    <div class="container bg-white p-4 rounded-4 shadow-sm" style="max-width: 1000px;">
        ...
        <div id="estimator-section">
            ...
            <div class="p-3 border rounded-3 bg-light mt-4" id="summary-section">
                ...
                <form action="https://api.web3forms.com/submit" method="POST" id="quote-form">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12 text-end">
                            <button type="submit" class="btn btn-success fw-bold px-4 py-2" id="submit-btn">Submit Request via Email</button>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-success text-white">
                    <h5 class="modal-title fw-bold" id="summaryModalLabel">Quotation Request Submitted!</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p class="text-muted small mb-3">Your details and selected summary have been sent successfully to your email.</p>
                    <div class="p-3 border rounded-3 bg-light">
                        <p class="mb-1"><strong>Layout:</strong> <span id="modal-layout">-</span></p>
                        <p class="mb-1"><strong>Combination:</strong> <span id="modal-combination">-</span></p>
                        <p class="mb-1"><strong>Panel Volume:</strong> <span id="modal-panel-vol">-</span> CFT</p>
                        <p class="mb-1"><strong>Frame Area:</strong> <span id="modal-frame-vol">-</span> SFT</p>
                        <p class="mb-1"><strong>Rate:</strong> <span id="modal-rate" class="fw-bold">-</span></p>
                        <hr>
                        <h4 class="fw-bold text-success mb-0">Total Estimated Cost: <span id="modal-total">₹0</span></h4>
                    </div>
                </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Handle AJAX Form Submit to Web3Forms and Show Pop-up
            document.getElementById('quote-form').addEventListener('submit', function(e) {
                ...
                .then(data => {
                    ...
                    if (data.success) {
                        // Populate values into Modal Summary
                        document.getElementById('modal-layout').textContent = document.getElementById('summary-layout').textContent;
                        document.getElementById('modal-combination').textContent = document.getElementById('summary-combination').textContent;
                        document.getElementById('modal-panel-vol').textContent = document.getElementById('summary-panel-vol').textContent;
                        document.getElementById('modal-frame-vol').textContent = document.getElementById('summary-frame-vol').textContent;
                        document.getElementById('modal-rate').textContent = document.getElementById('summary-rate').textContent;
                        document.getElementById('modal-total').textContent = document.getElementById('summary-total').textContent;

                        // Show Bootstrap Modal Pop-up Message
                        const summaryModal = new bootstrap.Modal(document.getElementById('summaryModal'));
                        summaryModal.show();

                        // Also reveal the on-page summary container after submit
